App = {
    ...
    initContracts: function () {
        $.getJSON("BoltcoinSale.json", function (boltcoinsale) {
            ...
            App.contracts.BoltcoinSale.deployed()
                .then(function (dapp) {
    ...
    render: function () {
        ...
        web3.eth.getCoinbase(function (err, account) {
            ...
            if (err == null) {
                ...
                App.contracts.Boltcoin.deployed()
                    .then(function (coin) {
                        coinInstance = coin;
    ...
    buyTokens: function () {
        ...
        App.contracts.BoltcoinSale.deployed()
            .then(function (dapp) {
                saleInstance = dapp;
                return saleInstance.buyTokens(numberOftokens, { from: App.account, value: numberOftokens * App.token_Price.toNumber(), gas: 5000000 });
            })
